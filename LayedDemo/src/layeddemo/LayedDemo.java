package layeddemo;
/*Swing provides a layered spin where you can arrange the components overlapping 
...
class MyFrame extends JFrame implements ActionListener
{
    ...
    MyFrame()
    {
        ...
        JPanel p1=new JPanel();  //Creating a panel and adding radio buttons to that panel
        p1.add(r1);
        p1.add(r2);
        p1.add(r3);
        ...
        l3.setOpaque(true);
          //creating a forth label which would move with cursor
        l4=new JLabel("b");
        ...
        //Now adding the panels to the frame
        add(p1,BorderLayout.NORTH);
        add(lp,BorderLayout.CENTER);
        
        //we have handled event using anonymous class
...
public class LayedDemo  //actually it should be layered 
{
