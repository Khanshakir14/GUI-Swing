...
class MyFrame extends JFrame implements ActionListener,ListSelectionListener,ChangeListener
{
    ...
    MyFrame()
    {
        ...
        cb=new JComboBox(countries); //this component is called VIEW, associated array is called MODEL , activity is called controller
       
        
        list=new JList(months);       //In short it is MVC:  Model View Controller
        list.setVisibleRowCount(5);   //So swing in Java supports MVC architechture 
